...
#include<string.h>
 int main() {
     char quest[5][100];
     char option1[3][200], option2[3][200], option3[3][200], option4[3][20], option5[3][20];
     ...
     strcpy(option3[0], "1. Prathiba Patil");
     strcpy(option3[1], "2. Sonia Gandhi");
     strcpy(option3[2], "3. Indira Gandhi");
     correct_ans[3] = 0;
     
     strcpy(quest[4], "Name the youngest prime minister of India");
     strcpy(option4[0], "1. Rajiv Gandhi");
     strcpy(option4[1], "2. Sanjay Gandhi");
     strcpy(option4[2], "3. Rahul Gandhi");
     correct_ans[4] = 0;
